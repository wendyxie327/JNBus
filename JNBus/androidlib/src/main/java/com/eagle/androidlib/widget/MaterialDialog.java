...
public class MaterialDialog {
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            mAlertDialog.getWindow()
                        .clearFlags( //WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE 点击back键，无法关闭对话框
                                WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE |
                                        //WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM 隐藏软键盘
                                        WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM);
            mAlertDialog.getWindow()
                        .setSoftInputMode( //SOFT_INPUT_MASK_STATE 软输入区域是否可见
    ...
    public static void setListViewHeightBasedOnChildren(ListView listView) {
        ...
        params.height = totalHeight +
                (listView.getDividerHeight() * (listAdapter.getCount() - 1));//listView.getDividerHeight() 获取子项间分隔符占用的高度
