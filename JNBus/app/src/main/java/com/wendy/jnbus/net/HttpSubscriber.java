 ...
 */
public class HttpSubscriber<T> extends Subscriber<T> implements ProgressCancelListener {
    ...
    public HttpSubscriber(SubscriberOnNextListener mSubscriberOnNextListener, Context context) {
